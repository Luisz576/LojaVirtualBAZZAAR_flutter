        ...
        children: [
          ...
          Align(
            ...
            child: Card(
              ...
              child: Padding(
                padding: EdgeInsets.symmetric(horizontal: 14 * (animationOpen.value > 0.0 ? animationOpen.value : 0.0), vertical: 7 * (animationOpen.value > 0 ? animationOpen.value : 0.0)),
                child: Text(produto.off.toString() + "%",
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: animationOpen.value > 0 ? 24 * animationOpen.value : 0.0,
